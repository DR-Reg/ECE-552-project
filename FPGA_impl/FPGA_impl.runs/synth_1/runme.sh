...
HD_PWD='C:/Users/dr309/Desktop/ECE-552-project/FPGA_impl/FPGA_impl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MpuHsa_Wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MpuHsa_Wrapper.tcl
