...
HD_PWD='C:/Users/dr309/Desktop/ECE-552-project/FPGA_impl/FPGA_impl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MpuHsa_Wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MpuHsa_Wrapper.tcl -notrace
