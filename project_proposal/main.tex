...
\title{ECE 552: Project Proposal\\ Micro-architectural Support for Packed Sparse Matrix Multiplication on Hybrid Systolic Arrays}
...
Additionally, time-permitting, the energy-performance tradeoff of utilising the equivalent MPU+VPU area for
just the (S)HSA structure (by increasing the number of MAC units) will also be evaluated.
\begin{figure}[!t]
    \centering
    \includegraphics[width=2.5in]{mpu-vpu-hsa.png}
    \caption{Comparison of the three structural systolic array architectures}
    \label{fig_1}
\end{figure}
